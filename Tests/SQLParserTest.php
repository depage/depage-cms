...
class SQLParserTest extends PHPUnit_Framework_TestCase
{
    ...
    public function testIncompleteStatement()
    {
        ...
        $this->assertEquals(array(), $this->parser->parseLine("ALTER TABLE\n"));

        // completed...
        $this->assertEquals(array("ALTER TABLE test COMMENT 'version 0.2'"), $this->parser->parseLine("test COMMENT 'version 0.2';\n"));
    }
    // }}}
    ...
    {
        // complete statement
        $this->assertEquals(array("ALTER TABLE test COMMENT 'version 0.2'"), $this->parser->parseLine("ALTER TABLE test COMMENT 'version 0.2';\n"));
    }
    // }}}
    ...
    public function testTwoStatementsInALine()
    {
        ...
        $this->assertEquals($expected, $this->parser->parseLine("ALTER TABLE test COMMENT 'version 0.2'; ALTER TABLE test COMMENT 'version 0.3';\n"));
    }
    // }}}
    // {{{ testHashComment
    public function testHashComment()
    {
        ...
        $this->assertEquals(array(), $this->parser->parseLine("ALTER TABLE # comment\n"));
    ...
    public function testMultilineStyleComment()
    {
        ...
        $this->assertEquals(array("ALTER TABLE test COMMENT 'version 0.2'"), $this->parser->parseLine("ALTER TABLE /* comment */ test COMMENT 'version 0.2';\n"));
    }
    // }}}
    ...
    public function testMultilineComment()
    {
        ...
        $this->assertEquals(array("ALTER TABLE test COMMENT 'version 0.2'"), $this->parser->parseLine("COMMENT 'version 0.2';\n"));
    }
    // }}}
    ...
    public function testMupltipleMultilineCommentMulti()
    {
        ...
        $this->assertEquals(array("ALTER TABLE test COMMENT 'version 0.2'"), $this->parser->parseLine("'version 0.2';\n"));
    }
    // }}}
    ...
    public function testSingleQuotedSemicolon()
    {
        ...
        $this->assertEquals(array("ALTER TABLE test COMMENT 'vers;ion 0.2'"), $this->parser->parseLine("ALTER TABLE test COMMENT 'vers;ion 0.2';\n"));
    }
    // }}}
    ...
    public function testMultipleWhitespacesInString()
    {
        ...
        $this->assertEquals(array("\"     \" '       '"), $this->parser->parseLine("\"     \" '       ';\n"));
    }
    // }}}
    ...
    public function testEscapedSingleQuotesInString()
    {
        ...
        $this->assertEquals(array("'str\'ing'"), $this->parser->parseLine("'str\'ing';\n"));
    }
    // }}}
