...
class_propBox.prototype.saveData = function(forceSave) {
	if (this.isChanged == true || forceSave == true) {
		this._parent.propObj.save(this.data.id);
		this.isChanged = false;
	}
	return true;
};
...
class_propBox_pg_colorscheme.prototype.saveData = function(forceSave) {
	if (this.isChanged == true || forceSave == true) {
		...
		this._parent.propObj.save(this.data.id, this.data, "colorscheme");
		this.isChanged = false;
	}
	return true;
};
...
class_propBox_pg_navigation.prototype.saveData = function(forceSave) {
	if (this.isChanged == true || forceSave == true) {
		...
		this._parent.propObj.save(this.data.id, this.data, "navigation");
		this.isChanged = false;
	}
	return true;
};
...
class_propBox_pg_file.prototype.saveData = function(forceSave) {
	if (this.isChanged == true || forceSave == true) {
		...
		this._parent.propObj.save(this.data.id, this.data, "file");
		this.isChanged = false;
	}
	return true;
};
...
class_propBox_edit_a.prototype.generateComponents = function() {
	...
	this.hrefBox.onDrop = function(droppedObj) {
		this._parent.hrefBox.value = conf.project.tree.pages.getUriById(droppedObj.id);
		this._parent.onChanged();
		this._parent.save();
	};
	...
	this.buttonHref.onClick = function() {
		...
		if (this._parent.hrefBox.value.substring(0, conf.url_page_scheme_intern.length + 2) == conf.url_page_scheme_intern + ":/") {
			...
			_root.mainInterface.interface.layouts.dlgChoose_page.setActive(this._parent._parent.propObj.saveFileRef, this._parent._parent.propObj, [href_id, this._parent.data.id]);
			...
			_root.mainInterface.interface.layouts.dlgChoose_file_link.setActive(this._parent._parent.propObj.saveFileRef, this._parent._parent.propObj, [href_id, this._parent.data.id]);
		} else {
			_root.mainInterface.interface.layouts.dlgChoose_page.setActive(this._parent._parent.propObj.saveFileRef, this._parent._parent.propObj, [href_id, this._parent.data.id]);
		}
	}
...
class_propBox_edit_img.prototype.load_thumb = function() {
	...
	this.buttonImg.onClick = function() {
		_root.mainInterface.interface.layouts.dlgChoose_files.setActive(this._parent._parent.propObj.saveFilePath, this._parent._parent.propObj, [this._parent.thumb.filepath, this._parent.data.id, "jpg,jpeg,gif,png", this._parent.data.attributes.force_width, this._parent.data.attributes.force_height]);
	}
	this.buttonHref.onClick = function() {
		var href_id = "";
		if (this._parent.hrefBox.value.substring(0, conf.url_page_scheme_intern.length + 2) == conf.url_page_scheme_intern + ":/") {
...
class_propBox_pg_template_data.prototype.resetData = function() {
	...
	this._parent.propObj.setTemplatePropType(this.data.id, this.comboBox.values[this.comboBox.selected]);
	this._parent.propObj.setTemplatePropActive(this.data.id, this.checkBox.value);
};
// }}}
// {{{ setData()
...
class_propBox_pg_template_data.prototype.generateComponents = function() {
	...
	this.comboBox.onChanged = function() {
		if (this.selected > 0) {
			this._parent._parent.propObj.setTemplatePropType(this._parent.data.id, this.values[this.selected]);
		} else {
			this._parent._parent.propObj.setTemplatePropType(this._parent.data.id, "");
		}
		this._parent.onChanged();
	};
	...
	this.checkBox.onChanged = function() {
		this._parent._parent.propObj.setTemplatePropActive(this._parent.data.id, this.value);
		this._parent.onChanged();
	};
};
// }}}
...
class_propBox_proj_publish_folder.prototype.generateComponents = function() {
	...
	this.buttonStart.onClick = function() {
		...
		conf.project.publishProject(this._parent.data.id);
	};
