...
_global.RegExp = Object.RegExp; // Make it global
...
String.prototype.regsearch = function() {
...
String.prototype.regsplit = function() {
	...
	if (typeof(arguments[0]) == "object" && arguments[0].const == "RegExp") {
		...
		return this.split(arguments[0], arguments[1]);
	}
}
