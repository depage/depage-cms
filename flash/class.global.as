...
class_user.prototype.mayDeletePages = function() { return this.level <= 5; };
class_user.prototype.mayEditSourceCode = function() { return this.level <= 3; };
// }}}
// {{{ user auth file
class_user.prototype.mayRenameFolder = function() { return this.level <= 5; };
class_user.prototype.mayDeleteFolder = function() { return this.level <= 5; };
class_user.prototype.mayRenameFiles = function() { return this.level <= 5; };
class_user.prototype.mayDeleteFiles = function() { return this.level <= 5; };
// }}}
// {{{ user auth colors
class_user.prototype.mayEditColors = function() { return this.level <= 5; };
...
// }}}
// {{{ user auth settings
class_user.prototype.mayPublish = function() { return this.level <= 4; };
class_user.prototype.mayEditSettings = function() { return this.level <= 4; };
class_user.prototype.mayEditSettingsPublish = function() { return this.level <= 3; };
class_user.prototype.mayEditSettingsTemplateSets = function() { return this.mayEditTemplates(); };
class_user.prototype.mayBackup = function() { return false; };
class_user.prototype.mayEditSettingsLanguages = function() { return this.level <= 1; };
class_user.prototype.mayEditSettingsNavigation = function() { return this.level <= 3; };
