...
namespace Depage\Redirector {
    ...
    class Redirector
    {
         ...
         * @return void
         **/
        public function setAlternatePages(array $urls): self
        {
         ...
         * @return void
         **/
        public function setRootAliases(array $aliases): self
        {
         ...
         * @return void
         **/
        public function setPublishId($publishId): self
        {
        ...
        public function loadMissingResource(&$uri)
        {
            ...
            $url = $this->apiUrl . "api/depage/resource/get/";
