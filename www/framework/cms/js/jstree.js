...
$(function () {
	$(".jstree-container").each(function () {
		$(this).jstree({ 
			...
			"plugins" : ($(this).attr("data-plugins") || "themes pedantic_html_data ui crrm dnd_placeholder types hotkeys contextmenu span dblclick_rename tooltips select_created_nodes delta_updates" ).split(" "),
